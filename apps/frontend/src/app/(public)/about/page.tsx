...
//
// GAMBAR DUMMY — taruh file apa saja (sementara) di public/images/
// dengan nama-nama berikut, ganti nanti dengan foto asli:
//   about-hero.jpg
//   about-story-1.jpg
//   about-story-2.jpg
//   about-process-1.jpg
...
export default function AboutPage() {
  ...
  // Animasi scroll-reveal untuk seluruh halaman —
  // pola sama seperti section lain di homepage
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-end gap-10 lg:gap-16">
            ...
            <div className="lg:w-[52%]">
              ...
              >
                Naia lahir dari satu pertanyaan sederhana — kenapa momen
                istimewa harus dibatasi oleh lemari pakaian? Kami percaya gaun
                terbaik adalah yang membuatmu merasa jadi dirimu sendiri, sekali
                pakai atau seribu kali.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          <div className="lg:w-[45%]">
            ...
            >
              ...
              — jahitan, kain, hingga aksesoris kecil sekalipun. Setelah
              dipakai, kami bawa ke dry cleaning khusus yang memahami cara
              merawat bahan-bahan halus.
            </p>
            <p
              data-reveal
              data-delay="0.28"
